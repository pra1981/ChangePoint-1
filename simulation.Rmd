...
Load all the necessary package and algorithm.

## Simulation
First we test the simulation without any covariate, so that $Y_i \sim N(\mu_i,\sigma^2)$
...
sim_list=list(SIFS=result_SIFS,SIFS_normalized=result_SIFS_nor,LS_TV1=result_LSTV_1,LS_TV2=result_LSTV_2)
makeTable(sim_list)
...
K=12
break_point = c(10, 13, 15, 23, 25, 40, 44, 65, 76, 78, 81)*n/100
Beta = matrix(c(0, 40,-10, 20,-20, 30,-12,  9, 52, 21, 42,  0)/200 -0.8,nrow=1,byrow = TRUE)
```
